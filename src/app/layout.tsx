...
export const metadata: Metadata = {
  ...
  title: "Mohamed Riham | AI Developer & Data Science Undergraduate | Addalaichenai, Sri Lanka",
  description: "Professional portfolio of Mohamed Riham — Software Engineer and Data Science Undergraduate from Addalaichenai, Sri Lanka. Specializing in Edge AI, YOLOv8, privacy-first offline systems, and SOLID-pattern software architectures.",
  ...
  authors: [{ name: "Mohamed Riham" }],
  openGraph: {
    title: "Mohamed Riham | AI Developer & Data Science Undergraduate",
  ...
  twitter: {
    ...
    title: "Mohamed Riham | AI Developer",
